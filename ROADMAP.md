...
| Distribution `hal.10` | `hal.10-alpha.32`: rollback hal.6 ferme par domaine de credentials |
...
Etat source `hal.10-alpha.32`: toute promotion reconstruit proprement le
