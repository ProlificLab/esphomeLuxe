...
| Distribution `hal.10` | `hal.10-alpha.24`: scellement atomique du dossier canari depuis les preuves exactes |
...
Etat source `hal.10-alpha.24`: toute promotion reconstruit proprement le
