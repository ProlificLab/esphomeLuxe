...
Do not rename build outputs or edit manifest checksums by hand. Follow the
endurance-gated publication, exact OTA installation and verified rollback
procedure in [docs/INSTALLATION.md](docs/INSTALLATION.md) and
