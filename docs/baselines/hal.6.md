...
3. If OTA is unavailable, flash the archived recovery image by USB and restore
   the API encryption key with `scripts/configure_home_assistant_encryption.py`.
